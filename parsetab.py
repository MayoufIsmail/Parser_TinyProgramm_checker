...
_lr_productions = [
  ...
  ('expression -> expression PLUS expression','expression',3,'p_expression','tiny_parser.py',42),
  ('expression -> expression MINUS expression','expression',3,'p_expression','tiny_parser.py',43),
  ('expression -> expression TIMES expression','expression',3,'p_expression','tiny_parser.py',44),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression','tiny_parser.py',45),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression','tiny_parser.py',46),
  ('expression -> NUMBER','expression',1,'p_expression','tiny_parser.py',47),
]
